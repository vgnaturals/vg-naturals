...
export const metadata: Metadata = {
  title: "Tulsi Essential Oil — 100% Pure & Farm-Distilled | VG Naturals",
  description:
    "Pure, farm-grown Tulsi Essential Oil, steam-distilled in small batches. Available in 50ml & 100ml. Bulk/B2B pricing available.",
};
...
const uses = [
  ...
  { icon: Droplets, text: "Diluted wellness & skincare blends" },
];

export default function TulsiEssentialOilPage() {
  return (
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          ...
          <h1 className="mt-3 font-display text-3xl leading-[1.15] text-forest sm:text-4xl">
            Tulsi Essential Oil — 100% Pure, Farm-Grown &amp; Steam-Distilled
          </h1>
          <p className="mt-5 font-body text-lg text-ink/75">
            100% pure, steam-distilled from tulsi (holy basil) cultivated on our
            own farm. Warm, herbaceous, slightly spicy aroma.
          </p>
