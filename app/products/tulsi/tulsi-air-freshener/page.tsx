...
import { Wind, Sofa, Car, Recycle, ShieldAlert, Info } from "lucide-react";
import ProductBuyBox from "@/components/ProductBuyBox";

export const metadata: Metadata = {
  title: "Tulsi Room & Fabric Air Freshener | VG Naturals",
  description:
    "Natural Tulsi Air Freshener spray, concentrated hydrosol blend. Available in 50ml & 100ml.",
};

const uses = [
  { icon: Wind, text: "Rooms" },
  { icon: Sofa, text: "Curtains & fabric" },
  { icon: Car, text: "Cars" },
];

export default function TulsiAirFreshenerPage() {
  return (
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden rounded-sm border border-forest/10 shadow-xl shadow-forest/10">
            <Image
              src="/products/tulsi-air-freshener.png"
        ...
        <div>
          <div className="flex items-center gap-2 font-body text-sm font-medium text-gold">
            ...
            100% water-based · No alcohol
          </div>
          <h1 className="mt-3 font-display text-3xl leading-[1.15] text-forest sm:text-4xl">
            Tulsi Air Freshener — Concentrated Room &amp; Fabric Spray
          </h1>
          <p className="mt-5 font-body text-lg text-ink/75">
            A stronger-concentration Tulsi Hydrosol blend, 100% water-based (no
            alcohol), for a longer-lasting fragrance throw than the regular
            hydrosol.
          </p>

          <div className="mt-8">
            <ProductBuyBox
              productName="Tulsi Air Freshener"
              price50ml={250}
              price100ml={300}
            />
          </div>
          ...
          <div className="flex items-start gap-3 rounded-sm border border-gold/40 bg-gold/10 p-5">
            ...
            <div>
              ...
              <p className="mt-1 font-body text-sm text-ink/70">
                Avoid contact with eyes. Keep out of reach of children. Do not
                ingest.
              </p>
            </div>
          </div>
