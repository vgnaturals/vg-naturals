...
export const metadata: Metadata = {
  title: "Lemongrass Hydrosol — Natural Toner & Mist",
  description:
    "Gentle, farm-distilled Lemongrass Hydrosol. Available in 50ml & 100ml. Use as a facial toner, hair mist, or room spray.",
};
...
export default function LemongrassHydrosolPage() {
  return (
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          ...
          <h1 className="mt-3 font-display text-3xl leading-[1.15] text-forest sm:text-4xl">
            Lemongrass Hydrosol — Gentle, Farm-Distilled Lemongrass Water
          </h1>
          <p className="mt-5 font-body text-lg text-ink/75">
            The natural water by-product of our Lemongrass Oil distillation —
            same batch, zero-waste story.
          </p>

          <div className="mt-8">
            <ProductBuyBox
              productName="Lemongrass Hydrosol"
              price50ml={250}
              price100ml={300}
            />
          </div>
